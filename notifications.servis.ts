...
// ruan repositorin notification si private property ne notificationsRepository
    constructor(@InjectRepository(notifications) private readonly notificationsRepository: Repository<notifications>) {}
    // krijimi i gjeneratorit asinkron createwithgenerator me parameter objektin Createnotifications
    async* createWithGenerator(dto: Createnotifications ): AsyncGenerator<notifications>{
